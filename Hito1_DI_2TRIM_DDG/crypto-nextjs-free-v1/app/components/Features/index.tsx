...
const featuresdata: featuresdata[] = [
    {
        ...
        heading: 'Seguridad',
        subheading: 'Tenemos un equipo especializado en asegurar sistemas de una manera eficiente.',
    },
    {
        imgSrc: '/images/Features/featureTwo.svg',
        heading: 'Precio',
        subheading: 'Ofrecemos varios planes de precios para que nuestros servicios sean accesibles para cualquier persona.',
    },
    {
        imgSrc: '/images/Features/featureThree.svg',
        heading: 'Almacenamiento',
        subheading: 'Poseemos grandes centros capaces de almacenar grandes cantidades de información, protegido por nuestro equipo.',
    },
]
    ...
    return (
        <div className="mx-auto max-w-7xl my-0 md:my-40 pt-36 px-6 relative" id="features-section">
            ...
            <div className="grid lg:grid-cols-2 gap-x-4 gap-y-4">
                {/* Column-1 */}
                <div>
                    <h3 className="feature-font text-lg font-semibold mb-4 text-center md:text-start">SERVICIOS</h3>
                    <h2 className="text-offwhite text-3xl lg:text-5xl font-semibold leading-snug mb-6 text-center md:text-start">Ventajas de nuestros servicios</h2>
